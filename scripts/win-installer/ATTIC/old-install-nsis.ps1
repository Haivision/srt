...
<#
 .DESCRIPTION
  ...
  IMPORTANT NOTE: This is the old version, left for historical reasons. Usage
  of this script is discouraged because this scripts doesn't check the MD5
  checksum on the downloaded file and therefore is considered unsafe.
