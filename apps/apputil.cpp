...
public: 
    ...
    { 
        ...
        output << "\"minflight\":" << mon.pktMinFlightSize;    
        output << "},";
        output << "\"link\":{";
...
public: 
    ...
    { 
        ...
        output << "WINDOW      FLOW: " << setw(11) << mon.pktFlowWindow      << "  CONGESTION: " << setw(11) << mon.pktCongestionWindow  << "  FLIGHT: " << mon.pktMinFlightSize << "-" << setw(11) << mon.pktFlightSize << endl;
